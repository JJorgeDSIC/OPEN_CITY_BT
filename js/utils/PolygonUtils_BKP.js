      ...
      //Regular forms...
        ...
        if(type === 1){
          ...
          if(biggerAxis == 0){ //X axis
            ...
            var rectangle = new CITY.RectanglePolygon(bounds.w/6, bounds.h, bounds.x + bounds.w, bounds.y + bounds.h);
            ...
            if(!difference){
              ...
              if(Math.random() > 10){
                 //T => L
                 CITY.PolygonUtils.translatePolygon(rectangle, 0 ,bounds.h/4);
                 CITY.PolygonUtils.scalePolygon(rectangle, 0.8, 1);
              }else{
                //T => L invertida
                CITY.PolygonUtils.translatePolygon(rectangle, 0 ,-bounds.h/4);
              }
          ...
          var bounds = buiildingPolyDefault;
          console.log(bounds);
          var lesserAxis = bounds.w - bounds.h > 0? 1:0;
          var pentagon;
          if(Math.random() < 0.2){
            pentagon = new CITY.PentagonPolygon(lesserAxis, bounds.x + bounds.w/2, bounds.y + bounds.h/2);
          ...
          if(Math.random() < 0.3){
            ...
            CITY.PolygonUtils.scalePolygon(anotherPoly, 0.5, 0.5);
