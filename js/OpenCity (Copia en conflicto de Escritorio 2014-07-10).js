...
CITY.FizzyText = function() {
  this.message = 'dat.gui';
  this.intensity = 0.8;
  this.displayOutline = false;
  this.explode = function() { console.log("Hello World")};
  // Define render logic ...
};


CITY.manipulation = function(){

	this.width = 1000;
	this.depth = 1000;
	this.streetAnchorField = 10;
	this.avenueAnchorField  = 10;
	this.numAvenues = 4;
...
CITY.BumpTestmaterial = new THREE.MeshPhongMaterial( { ambient: 0x552811,
 color: 0x552811,
 specular: 0x333333,
 shininess: 25,
